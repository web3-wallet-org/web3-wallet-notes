...
┌──────────────────────────▼──────────────────────────┐
│                  Swap Orchestrator                  │
│         route: same-chain / cross-chain / multi     │
└──────────┬──────────────────────────────┬───────────┘
           │                              │
           ▼                              ▼
┌──────────────────────┐        ┌──────────────────────┐
...
> - **Swap Orchestrator**：路由决策层，判断走同链 Swap 还是跨链桥
> - **Same-Chain DEX**：聚合器层，对接 1inch / 0x / Paraswap
> - **Cross-Chain Bridge**：跨链协议层，对接 Stargate / LayerZero / CCTP
> - **Transaction Builder**：构造交易 → 签名服务 → 广播 → 监控
